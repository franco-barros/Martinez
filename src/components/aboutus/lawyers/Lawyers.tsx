  ...
  const lawyers = [
    {
      ...
      bio: "Abogado egresado de la Universidad Nacional de San Juan. Cuenta con 10 años de experiencia en el ejercicio profesional en materia laboral y civil.",
      social: {
    ...
    {
      id: 3,
      name: "Dr. Pablo Andrés Portillo Borbore",
      bio: "Abogado con amplia experiencia en litigios civiles y comerciales. Ha trabajado como Analista Normativo en el Ministerio de Gobierno de San Juan y en proyectos de Digesto Jurídico de la Legislatura provincial y la Municipalidad de Santa Lucía. Cuenta también con experiencia como Administrativo Digital en el sector privado. Su formación incluye el título de Abogado por la Universidad Católica de Cuyo y un Grado en Derecho convalidado parcialmente en la UNIR (España).",
      social: {
        whatsapp: "https://wa.me/2645602490",
        linkedin:
          "https://www.linkedin.com/in/pablo-andres-portillo-borbore-228404235/",
      },
    },
  ];
