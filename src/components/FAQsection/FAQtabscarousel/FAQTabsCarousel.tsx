  ...
  },
  {
    ...
    questions: [
      ...
      },
      {
        ...
        answer:
          "Es un proceso legal para regularizar la propiedad de un inmueble tras 20 años de posesión continua.",
      },
      {
        question: "¿Qué hago si necesito asesoramiento urgente?",
        answer:
          "Podés contactarnos inmediatamente por WhatsApp o teléfono para recibir orientación inicial.",
      },
    ],
  },
];
